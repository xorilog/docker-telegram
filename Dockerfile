...
# Telegram Version 3.5.1
RUN env http_proxy=$http_proxy https_proxy=$https_proxy wget https://updates.tdesktop.com/tlinux/tsetup.3.5.1.tar.xz -O /tmp/telegram.tar.xz \
    && cd /tmp/ \
