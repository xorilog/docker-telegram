...
# Telegram Version 4.2.4
RUN env http_proxy=$http_proxy https_proxy=$https_proxy wget https://updates.tdesktop.com/tlinux/tsetup.4.2.4.tar.xz -O /tmp/telegram.tar.xz \
    && cd /tmp/ \
